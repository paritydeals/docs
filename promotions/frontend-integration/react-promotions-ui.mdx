...
```tsx
<PDPriceCurrencySymbol localizePricing={true} className="currency-symbol" />
```
...
```tsx
<PDPriceCurrencyCode localizePricing={true} className="currency-code" />
```
...
interface DefaultFormatConfig {
  ...
  localizePricing?: boolean;        // default: false
