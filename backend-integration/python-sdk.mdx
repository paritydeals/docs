...
* `customerId` (str): Required. A unique identifier for the customer that you define. This ID will be used to reference the customer in subsequent API calls. 
* `email` (Optional[str]): Required. The email address of the customer. Must be a valid email format.
* `name` (Optional[str], default: None): The name of the customer.
* `metadata` (Optional[Dict[str, Any]], default: None): A dictionary of custom key-value pairs to store additional information about the customer.
...
* `details` (Optional[Dict[str, Any]]): Any server-added details about the customer (typically read-only).
* `metadata` (Optional[Dict[str, Any]]): The metadata associated with the customer.
* `subscriptions` (Optional[int]): Typically represents the count of active subscriptions (may be 0 for new customers).
...
* `customerId` (str): Required. A unique identifier for the customer that you define.
* `email` (Optional[str]): Required. The email address of the customer. Must be a valid email format.
* `name` (Optional[str], default: None): The name of the customer.
* `metadata` (Optional[Dict[str, Any]], default: None): A dictionary of custom key-value pairs to store additional information about the customer.
...
**Parameters**:
    ...
    * `customerId` (str): Required. The unique identifier for the customer who performed the event. 

    * `eventName` (str): Required. The name of the event (e.g., "user_login", "item_purchased", "feature_activated"). 

    * `idempotencyKey` (str): Required. A unique client-generated key to ensure that the event is processed at most once, even if the request is retried. A UUID is a good choice. 
