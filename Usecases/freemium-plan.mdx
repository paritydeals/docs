...
2.  Select the Product that contains the plan you want to offer a trial for.
    * `[Image: ParityDeals Products list with "My Awesome App" highlighted.]`
3.  In the "Plans" section of the Product page, find your "Starter Plan" and click on it to open its details.
    * `[Image: Product detail page showing a list of plans, with "Starter Plan" highlighted.]`
4.  Click on **Set price** (or **Edit price** if pricing is already configured for the plan).
    * `[Image: "Starter Plan" detail page with the "Edit price" or "Set price" button highlighted.]`
...
2.  Locate the checkbox labeled **Provide free trial** and check it. [cite: 122]
    * `[Image: ParityDeals plan pricing modal, with the "Provide free trial" checkbox highlighted and checked.]`
3.  Once checked, options for the trial duration will appear.
    ...
    * `[Image: Trial period configuration showing "14" entered and "days" selected.]`
...
2.  Select the desired outcome from the available choices[cite: 123]:
    ...
    * `[Image: Post-trial action options highlighted, e.g., "Downgrade to free plan" selected.]`
