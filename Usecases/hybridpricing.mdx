...
![A detailed feature comparison table from the ElevenLabs website.](https://storage.googleapis.com/gemini-prod/images/5f653158-958a-4422-9226-d18306dfda8e)
...
![The pricing plans on the ElevenLabs website.](https://storage.googleapis.com/gemini-prod/images/87e83713-3a56-4273-9a3c-b1660d268d87)
...
Finally, create a paywall to present the plans and activate it with an Offering.

1.  Navigate to **Monetization > Paywalls** and click **+ Create Paywall**.
...
5.  Select the paywall you just designed to link it to the product.
6.  Click **Create** and use the generated **Offering ID** in your application to render the paywall.