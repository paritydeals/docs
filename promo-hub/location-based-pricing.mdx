...
---
<Info>
  **Is Promo Hub for you?**
  If you are a creator or company focused on running location-based pricing promotions (like Purchasing Power Parity discounts) without managing full subscription plans within ParityDeals, the Promo Hub is the direct tool for this purpose.
...
## What is the Promo Hub?

The ParityDeals Promo Hub enables you to implement purchasing power parity (PPP) pricing and other location-based discounts, allowing you to offer fair prices worldwide and increase your sales revenue growth.
...
<Frame>
<img height="200" src="/images/promo-hub-empty-state-globe.png" alt="Promo Hub empty state with globe illustration" />
</Frame>
...
1.  From the main sidebar, navigate to **Promo Hub**.
...
1.  Navigate to **Promo Hub** from the sidebar and click **"+ Create promotion"**.
...
<Tabs>
  <Tab title="Banner Customization & Integration">
    ...
    First, add a single line of code—a tiny JavaScript file—to your website's HTML to enable the display of discount banners.
...
1.  Navigate to the **Promo Hub** list page.
