...
<Info>
  **Are Promotions for you?**
  ...
  For a full subscription business model with metered usage, feature entitlements, and advanced pricing models, use the tools within the **[Product Catalog](/quickstart/core-concepts)** and **[Monetization](/monetization/targeting-rules)** sections.
</Info>
...
1.  Once you are satisfied with your discount settings, click the **"Create promotion"** button at the bottom-right of the page.
...
1.  Once all discounts and coupon codes are set, click the **"Create promotion"** button at the bottom-right corner.
