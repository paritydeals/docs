...
The SDK currently supports the following operations:
    ...
    1. [Customers](/api-reference/backend-integration/python-sdk#customers)

    2. [Checkout](/api-reference/backend-integration/python-sdk#checkout)

    3. [Entitlements](/api-reference/backend-integration/python-sdk#entitlements)

    4. [Reporting](/api-reference/backend-integration/python-sdk#reporting)

    5. [Subscriptions](/api-reference/backend-integration/python-sdk#subscriptions)
...
The SDK can connect to the ParityDeals sandbox environment, which is perfect for **testing and development**. All operations performed in the sandbox are isolated and will not affect your live production data.
...
client = ParityDeals.create_sync_client(
