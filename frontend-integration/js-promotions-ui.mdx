...
<div class="price-container" data-pd-original-price="99">
  ...
  <span class="integer" data-pd-price-decimal-point></span>
...
| `bar.unStyled`       | boolean | false    | if true, no styling will be applied to the banner    |
| `bar.showCloseButton`| boolean | true     | Control close button visibility. This setting will work only if close button is enabled from the ParityDeals banner settings   |
...
```html
<div data-pd-original-price="99" data-pd-show-decimal="false">
  <span class="currency" data-pd-currency-symbol></span>
  <span class="integer" data-pd-price-integer></span>
</div>
```
