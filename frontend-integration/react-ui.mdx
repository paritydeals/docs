---
title: "ParityDeals React UI SDK"
...
:root {
  --pd-card-bg: #ffffff;
  --pd-title-color: #333333;
  --pd-description-color: #666666;
  --pd-price-color: #000000;
  --pd-button-bg: #007bff;
  --pd-button-color: #ffffff;
  --pd-button-hover-bg: #0056b3;
  --pd-billing-switch-bg: #f8f9fa;
  --pd-billing-switch-color: #6c757d;
  --pd-billing-switch-selected-color: #007bff;
  --pd-gap: 20px;
  --pd-min-width: 280px;
  --pd-max-width: 400px;
}
