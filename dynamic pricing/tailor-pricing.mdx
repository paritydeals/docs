...
1.  **Define Conditions:** You set up rules based on customer attributes such as:
    ...
    * `Platform / OS` (e.g., Android, iOS, Windows) [cite: 312, 328]
    * `Browser` (e.g., Chrome, Safari, Firefox) [cite: 312, 328]
...
3.  **Link the Targeting Rule:**
    ...
    * `[Image: "Create offering" modal showing the "Targeting rule" option selected and a rule chosen from a dropdown.]`
