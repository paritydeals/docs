...
1.  **In the "Create offering" (or "Edit offering") modal:**
    * **Pricing Table Linking (Optional):** An option exists to "Skip if you don't want to link a pricing table to this offering." If your Offering's purpose is *only* to apply rule-based price adjustments without changing the visual pricing table structure, you can skip this. Most often, however, you will link a pricing table.
